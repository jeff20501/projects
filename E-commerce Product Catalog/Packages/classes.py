...
class Electronics(Product):
    ...
    def apply_discounts(self):
        print(f"The product Name: {self.name} Price: {self.price}. The price after discount is applied: {discounts_calc()}")
...
class Catalog:
    ...
    def apply_discounts(self):
        for pro in self.catalog:
            print(f"The product Name: {pro.name} Price: {pro.price}. The price after the discount is applied {discounts_calc()}")
