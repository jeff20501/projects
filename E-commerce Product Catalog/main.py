                    ...
                    if choice_electronics == 1:
                        ...
                        for ele in electronics_list:
                            if ele.name == name_product_apply_discount:
                                if ele.price > 3000:
                                    ele.apply_discounts() # The price will be updated within this method
                                else: 
                    ...
                    if choice_clothing ==  1:
                        ...
                        for pro in electronics_list:
                            if pro.name == name_product_apply_discount_clo:
                                if pro.price > 3000:
                                    pro.apply_discounts() # The price will be updated within this method
                                    product_found=True
                                    break
                                else: 
                ...
                if choice_add_item == 1:
                   ...
                   for item in items.catalog:
                        if item.name == name_product_apply_discount_catalog:
                           if item.price > 3000:
                               item.apply_discounts() # The price will be updated within this method
                               product_found=True
                               break
                           else:
